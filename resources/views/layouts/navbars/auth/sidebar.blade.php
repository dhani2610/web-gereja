...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        {{-- <img src="../assets/img/logo-dashboard.png" class="navbar-brand-img h-100" alt="..."> --}}
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('slider') ? 'active' : '') }}" href="{{ url('slider') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-images ps-2 pe-2 text-center text-dark {{ (Request::is('slider') ? 'text-white' : 'text-dark') }}" aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('galery') ? 'active' : '') }}" href="{{ url('galery') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-images ps-2 pe-2 text-center text-dark {{ (Request::is('galery') ? 'text-white' : 'text-dark') }}" aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('donasi') ? 'active' : '') }}" href="{{ url('donasi') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('donasi') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
