                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <form role="form text-left" method="POST" action="{{ route('slider-store') }}"
                        ...
                        @foreach ($slider as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <img src="{{ asset('assets/img/slider/'.$item->img) }}" style="max-width: 300px"
                                         alt="">
                                </td>
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('slider-delete',$item->id) }}" type="button">
        ...
        <div class="modal fade" id="modaledit{{ $item2->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <form role="form text-left" method="POST" action="{{ route('slider-update',$item2->id) }}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="">Foto</label>
                                <br>
                                <img src="{{ asset('assets/img/slider/'.$item2->img) }}" style="max-width: 100px"
                                     alt="">
                                <br>
