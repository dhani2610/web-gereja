                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <form role="form text-left" method="POST" action="{{ route('warta-jemaat-store') }}"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="file" class="form-control"  name="file"
                                                       id="foto" value="{{ old('file') }}" required>
                                                @error('file')
                        ...
                        @foreach ($warta as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <img src="{{ asset('assets/img/foto-warta/'.$item->foto) }}" style="max-width: 300px"
                                         alt="">
                                </td>
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold mb-0">
                                        <a href="{{ asset('assets/file-warta/'.$item->file) }}" download> {{ $item->file }}</a>
                                    </p>
                                </td>
                                <td class="text-center">
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('warta-jemaat-delete',$item->id) }}" type="button">
        ...
        <div class="modal fade" id="modaledit{{ $item2->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <form role="form text-left" method="POST" action="{{ route('warta-jemaat-update',$item2->id) }}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="">File</label>
                                <br>
                                <a href="{{ asset('assets/file-warta/'.$item2->file) }}" download> {{ $item2->file}}</a>
                                <br>
                                <input type="file" class="form-control"  name="file"
                                       id="foto" value="{{ old('file') }}" >
                                @error('file')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="mb-3">
                                <label for="">Foto</label>
                                <br>
                                <img src="{{ asset('assets/img/foto-warta/'.$item2->foto) }}" style="max-width: 300px"
                                alt="">
                                <br>
                                <input type="file" class="form-control" placeholder="Foto" name="foto"
                            ...
                            <div class="mb-3">
                                <label for="">Judul</label>
                                <input type="text" class="form-control" placeholder="Judul" name="judul"
                                       id="judul" value="{{ old('judul') ?? $item2->judul }}" required>
                                @error('judul')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="">Keterangan</label>
                                <textarea name="keterangan" class="form-control" id="" cols="30" rows="10">{{ $item2->keterangan  }}</textarea>
                                @error('keterangan')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
